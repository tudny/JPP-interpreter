...
instance Print (Src.Jabba.Abs.Instr' a) where
  prt i = \case
    ...
    Src.Jabba.Abs.IIfElif _ expr block1 elifs block2 -> prPrec i 0 (concatD [doc (showString "if"), prt 0 expr, prt 0 block1, prt 0 elifs, doc (showString "else"), prt 0 block2])
