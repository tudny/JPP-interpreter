...
Instr
  ...
  | 'yield' Expr ';' { (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1), Src.Jabba.Abs.IYield (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
  | 'yield' ';' { (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1), Src.Jabba.Abs.IYieldUnit (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1))) }
...
Type
  ...
  | 'Gen' '[' Type ']' { (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1), Src.Jabba.Abs.TGen (uncurry Src.Jabba.Abs.BNFC'Position (tokenLineCol $1)) (snd $3)) }
...
Expr6
  ...
  | Ident '(' ListExpr ')' { (fst $1, Src.Jabba.Abs.ERun (fst $1) (snd $1) (snd $3)) }
